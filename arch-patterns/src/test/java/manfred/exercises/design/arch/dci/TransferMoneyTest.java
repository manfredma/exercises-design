...
import manfred.exercises.design.arch.dci.context.PayBillsContext;
import manfred.exercises.design.arch.dci.context.TransferMoneyContext;
...
import manfred.exercises.design.arch.dci.rolemap.CheckingAccountRolemap;
import manfred.exercises.design.arch.dci.rolemap.CreditorRolemap;
import manfred.exercises.design.arch.dci.rolemap.SavingsAccountRolemap;
...
/**
 * TransferMoneyContext 转账上下文测试（Polygene Mixin 版本）。
 */
